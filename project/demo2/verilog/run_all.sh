...
cp summary.log ../verification/results/simple.summary.log
...
cp summary.log ../verification/results/complex.summary.log
...
cp summary.log ../verification/results/rand_simple.summary.log
...
cp summary.log ../verification/results/complex_demo2.summary.log

wsrun.pl -pipe -list ../verification/mytests/all.list proc_hier_pbench *.v
cp summary.log ../verification/results/mytests.summary.log
